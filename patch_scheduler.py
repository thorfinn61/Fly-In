...
with open("src/models/scheduler.py", "r") as f:
    content = f.read()
...
content = re.sub(r'class Scheduler:.*', scheduler_code.strip(), content, flags=re.DOTALL)

with open("src/models/scheduler.py", "w") as f:
    f.write(content)
